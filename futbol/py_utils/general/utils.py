...
def spread_array_by_factor(array: List[Union[int, float]],
                           factor: int) -> List[Union[int, float]]:
    """
...
def spread_array_by_length(array: List[Union[int, float]],
                           to: int) -> List[Union[int, float]]:
    """
    Definition:
